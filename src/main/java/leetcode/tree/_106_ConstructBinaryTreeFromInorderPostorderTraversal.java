 ...
 *
 */
public class _106_ConstructBinaryTreeFromInorderPostorderTraversal {
    ...
    public static void main(String[] args){
        _106_ConstructBinaryTreeFromInorderPostorderTraversal test=new
                _106_ConstructBinaryTreeFromInorderPostorderTraversal();
